...
This is a Python (2 and 3) library that provides a **Video File based eye tracking system**. It gives you the exact position of the pupils and the gaze direction, in real time.
